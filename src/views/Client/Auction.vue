  ...
  <div class="page">
    ...
    <div class="fields">
      ...
      <div class="bids">
        ...
        <div class="bids__wallet-info">O arremate é de R$ {{auction.closePrice | number}}</div>
        ...
        <div v-else-if="auction.status == 'finalized'" class="closed-auction bids__chat">
        ...
        <div v-else class="closed-auction bids__chat">
          <span class="closed-auction__message">Carregando...</span>
        </div>
