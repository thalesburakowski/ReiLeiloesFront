			...
			<div class="fields">
				<div class="line-inputs">
					<label class="label-input">
						<input type="text" maxlength="80" v-model="auction.title" required v-validate="'required'">
            ...
            <label class="label-input label-input--date">
              ...
              <div class="label-text">Horário</div>
				...
				<div class="line-inputs">
					...
					<label class="label-input">
						<input type="text" required v-model="auction.width" v-validate="'required'" v-mask="'######'">
						<div class="label-text">Largura (em cm)</div>
					</label>
					<label class="label-input">
						<input type="text" required v-model="auction.depth" v-validate="'required'" v-mask="'######'">
